        ...
        <div className="bg-[#17131f] rounded-[2.4rem] overflow-hidden flex-1 flex flex-col min-h-0 relative">
          ...
          {canDM && (
            <div className="flex-shrink-0 border-t border-black/10 bg-white px-2.5 py-2 flex flex-col gap-1.5">
              ...
              <p className="text-xs text-[#65597b]">轻量问候 · 今日剩余 {dmLeft} 条 · 深入聊天请在地图见面</p>
              <div className="flex gap-1.5">
                ...
                <button onClick={sendDM} disabled={dmLeft <= 0} aria-label="发送私信" className="min-w-11 rounded-xl bg-[#5B6BB0] text-white disabled:opacity-40 flex items-center justify-center"><Send size={16}/></button>
              </div>
            </div>
          )}
        </div>
